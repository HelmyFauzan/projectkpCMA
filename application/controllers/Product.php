...
class Product extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['content']    = $this->product->select(
                [
                    'product.id', 'product.title AS product_title', 'product.image', 'product.color', 'product.price', 'product.is_available',
    ...
    public function edit($id)
    {
        ...
        if (!$data['content']) {
            $this->session->set_flashdata('Maaf data tidak ditemukan');
            redirect(base_url('product'));
        }
        ...
        if ($this->product->where('id', $id)->update($data['input'])) {   // Update data
            $this->session->set_flashdata('Data berhasil diubah');
        } else {
    ...
    public function delete($id)
    {
        ...
        if (!$product) {
            $this->session->set_flashdata('Data tidak ditemukan');
            redirect(base_url('product'));
        }
