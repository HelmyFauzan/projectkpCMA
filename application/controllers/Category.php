...
class Category extends MY_Controller
{
    ...
    {
        $data['content'] = $this->category->where('id', $id)->first();  // Ambil data id
        ...
        if ($this->category->where('id', $id)->update($data['input'])) {    
            $this->session->set_flashdata('Data berhasil diperbaharui');
        } else {
            $this->session->set_flashdata('Terjadi suatu kesalahan');
        }
    ...
    public function delete($id)
    {
        ...
        if ($this->category->where('id', $id)->delete()) { 
            $this->session->set_flashdata('Data sudah berhasil dihapus');
        } else {
            $this->session->set_flashdata('Terjadi suatu kesalahan');
        }
